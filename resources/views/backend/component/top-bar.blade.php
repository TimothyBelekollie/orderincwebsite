<div class="relative z-[51] flex h-[67px] items-center border-b border-slate-200">
    ...
    <!-- BEGIN: Account Menu -->
    <div data-tw-merge="" data-tw-placement="bottom-end" class="dropdown relative"><button data-tw-toggle="dropdown" aria-expanded="false" class="cursor-pointer image-fit zoom-in intro-x block h-8 w-8 overflow-hidden rounded-full shadow-lg">
        <img src="{{asset('backend/dist/images/fakers/profile-1.jpg')}}" alt="Midone - Tailwind Admin Dashboard Template">
        </button>
